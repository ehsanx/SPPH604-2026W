...
|---|---|---|
| **This week’s lecture** | [Week 2 — NHANES data sources; reading Methods critically](https://ehsanx.github.io/SPPH604-2026W/lectures/Week2_nhanes_and_reading_methods.html) | Tuesday read the demonstration paper’s Methods section as the first act of reproduction, and gave you the six questions to ask of any Methods section. It also previewed this lab’s code directly — `nhanes("DEMO_H")`, `full_join(..., by = "SEQN")`, the cycle loop and `bind_rows()`. This lab runs it: several NHANES cycles downloaded, the raw topic files read, and everything merged on `SEQN` into one row per person. |
...
| **Lock your paper** | [M0 — Feasibility memo](https://ehsanx.github.io/SPPH604-2026W/milestones/M0_assignment.html) | Use this week’s template and the M0 criteria to shortlist two or three candidate NHANES papers of your own. You lock one at M0 in Week 3. |
| **Worked example** | [M0 example](https://ehsanx.github.io/SPPH604-2026W/examples/M0_feasibility/M0_feasibility_memo.html) | A completed feasibility memo, so you can see how much evidence each M0 criterion actually needs. |
| **Next increment** | [P1 — Analytic cohort](https://ehsanx.github.io/SPPH604-2026W/practice/P1_analytic_cohort.html) | P1 begins in Week 3, once your paper is locked, and applies **L2** rather than this lab. There are six labs and five increments: L1 is the one that feeds M0 instead. |
| **Milestone** | [M1 — Replication and interrogation](https://ehsanx.github.io/SPPH604-2026W/milestones/M1_assignment.html) | Only through the paper you lock at M0. Nothing you build today is submitted for M1. |
